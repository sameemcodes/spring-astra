...
public class LocationUdt {
   ...
   *
   * @return current value of 'x_coordinate'
   */
   ...
   *
   * @param x_coordinate new value for 'x_coordinate '
   */
   ...
   *
   * @return current value of 'y_coordinate'
   */
   ...
   *
   * @param y_coordinate new value for 'y_coordinate '
   */
   ...
   *
   * @return current value of 'z_coordinate'
   */
   ...
   *
   * @param z_coordinate new value for 'z_coordinate '
   */

...
public abstract class AbstractInstrumentReading {
   ...
   *
   * @return current value of 'spacecraft_name'
   */
   ...
   *
   * @param spacecraft_name new value for 'spacecraft_name '
   */
   ...
   *
   * @return current value of 'journey_id'
   */
   ...
   *
   * @param journey_id new value for 'journey_id '
   */
   ...
   *
   * @return current value of 'reading_time'
   */
   ...
   *
   * @param reading_time new value for 'reading_time '
   */

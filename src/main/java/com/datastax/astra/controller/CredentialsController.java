...
public class CredentialsController {
   ...
   *
   * @param username HTTP POST PARAM user name
   * @param password HTTP POST PARAM password
   * @param keyspace name of keysapce
   * @return status of connection
   * @throws IOException cannot process incoming file
   */
  @PostMapping

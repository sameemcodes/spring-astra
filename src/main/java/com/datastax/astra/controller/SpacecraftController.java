...
public class SpacecraftController {
   ...
   * Constructor.
   *
   * @param spacecraftService service implementation
   */
   ...
   *
   * @return list all {@link SpacecraftJourneyCatalog} available in the table
   */
  ...
  /**
   * List all journeys for a dedicated spacecraft. If the spacecraft is not found we will show an empty list (an dnot
   * 404.)
   *
   * @param spacecraft_name spacecraft_name to locate journeys
   * @return list of associated journey, can be empty
   */
  ...
  @ApiResponses({
      ...
      @ApiResponse(code = 400,
                   message = "spacecraftName is blank or contains invalid characters (expecting AlphaNumeric)"),
  ...
  public ResponseEntity<SpacecraftJourneyCatalog> findSpacecraftJourney(
      @ApiParam(name = "spacecraftName", value = "Spacecraft name", example = "gemini3", required = true)
      @PathVariable(value = "spacecraftName") String spacecraftName,
      @ApiParam(name = "journeyId", value = "Identifer for journey", example = "abb7c000-c310-11ac-8080-808080808080",
                required = true)

...
public class SessionManager {
   ...
   *
   * @return singletong of the session Manager
   */
   ...
   * @param secureConnectionBundlePath zip bundle path on disl
   ...
   *
   * @param user                       sample user name
   * @param password                   sample password
   * @param keyspace                   sample keyspace
   * @param secureConnectionBundlePath temp file
   */
  public void testCredentials(String user, String passwd, String keyspce, String secureConnectionBundlePath) {
    ...
    try (CqlSession tmpSession = CqlSession
        .builder()
   ...
   *
   * @return current value of 'cqlSession'
   */
  public CqlSession connectToAstra() {
    ...
    if (null == cqlSession) {
      cqlSession = CqlSession
          .builder().withCloudSecureConnectBundle(Paths.get(getSecureConnectionBundlePath()))
   ...
   *
   * @return current value of 'secureConnectionBundlePath'
   */
   ...
   *
   * @return current value of 'initialized'
   */

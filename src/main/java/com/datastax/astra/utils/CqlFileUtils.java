...
public class CqlFileUtils {
  ...
  private static String loadFileAsString(String fileName)
    ...
    try {
      currentScan = new Scanner(in, StandardCharsets.UTF_8);
   ...
   *
   * @param dseSession current dse Session
   * @param fileName   cql file name to execute
   * @throws FileNotFoundException cql file has not been found.
   */
